...
引入方向，骑兵对侧翼后背发动冲击有巨大加成 骑兵冲击正面攻击惩罚
引入阵型背面，背面被攻击减50%，部队侧翼的侧翼移动力消耗*2 正面移动力消耗*1, 部队背面移动力消耗正常，计算移动力消耗部队背面优先级高于其他位置
只判断被攻击目标的侧翼情况，其他参战部队不考虑侧翼影响
一边侧翼被攻击战斗力-30% 两边侧翼被攻击战斗力-60%
