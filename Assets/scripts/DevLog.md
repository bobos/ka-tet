...
玩家宣战（需要积攒吊民伐罪值 设定宣战目标期）或者被宣战，进入战争模式
和平模式下命令分散到战争模式下具体某月执行
将领可能因历史事件被下狱或者弃用，被下狱有几率死亡，改换年号一定几率释放下狱将领，很大几率启用尘封将领，换皇帝必然启用下狱和弃用将领
战败可能追究主帅责任，可能下狱或者弃用
设定和平模式下命令
前期平北汉（两个行省, 第二行省有辽援军），中期取燕云，平西夏，后期取辽和吐蕃
将军超过50岁不可再战
游戏名字 通鉴：宋 或者 编年史: 宋
