...
namespace TextNS
{
  ...
  //   unit
      ...
      {"event_FormationBreaking", @"{0}: 什么土鸡瓦狗，不过尔尔!"},
      ...
      {"event_SiegeComplain", @"{0}士兵: 我{0}勇士半日即可拿下此城，何须筑此长围示弱于敌耶!"},
      ...
      {"title_attackerSmallWin", "攻方略占上风"},
      {"title_attackerGreatWin", "攻方小捷"},
      {"title_attackerCrushingWin", "攻方大捷"},
      {"title_attackerSmallLoss", "攻方略处下风"},
      {"title_attackerGreatLoss", "攻方小败"},
      {"title_attackerCrushingLoss", "攻方惨败"},
      ...
      {"ability_drillMaster", "忘战必危"},
      {"ability_drillMaster_description", "和平时期部队组织度不下降"},
      {"ability_fireBug", "火烧连营"},
      {"ability_fireBug_description", "任意密林都可以放火"},
      {"ability_ambusher", "神出鬼没"},
      {"ability_ambusher_description", "后勤不济时士气惩罚降为8点，暴雨不影响移动力，提升奇袭成功率20%"},
      {"ability_boxer", "一鼓作气"},
      {"ability_boxer_description", "战斗力增加100%"},
      {"ability_outlooker", "一目千里"},
      {"ability_outlooker_description", "浓雾不影响视野，发现视力范围内潜伏敌军，发现视野内敌军主帅"},
      {"ability_rally", "重整旗鼓"},
      {"ability_rally_description", "范围内部队士气+50, 移动力+40"},
      {"ability_holder", "寸步不让"},
      {"ability_holder_description", "被冲阵时或者被突围时坚守阵地几率+50"},
      {"ability_builder", "事倍功半"},
      {"ability_builder_description", "部队修建长围速度提升100%"},
      {"ability_fortifier", "固若金汤"},
      {"ability_fortifier_description", "部队守城时战斗力增加50%"},
      {"ability_herbist", "华佗再世"},
      {"ability_herbist_description", "治愈范围内部队的中毒，瘟疫以及高原反应状态"},
      {"ability_breacher", "先登"},
      {"ability_breacher_description", "攻城时部队战斗力提升80%"},
      {"ability_runner", "倍道而行"},
      {"ability_runner_description", "部队移动力增加80%"},
      {"ability_staminaManager", "回马枪"},
      {"ability_staminaManager_description", "部队能发动二次进攻"},
      {"ability_pusher", "锐不可当"},
      {"ability_pusher_description", "冲阵成功后，对方会后撤两格，即使冲阵失败对方士气下降额外+50%"},
      {"ability_finisher", "斩尽杀绝"},
      {"ability_finisher_description", "对溃败敌军造成的杀伤翻倍"},
      {"ability_sentinel", "草木皆兵"},
      ...
      {"ability_fearMonger", "人心惶惶"},
      {"ability_fearMonger_description", "当己方有部队出现在通往敌军前线的任一补给据点旁边时，该技能对范围内前线敌军造成30-60的士气打击"},
      {"ability_gameChanger", "锦囊妙计"},
      {"ability_gameChanger_description", "除本技能外，重置战场友军所有技能"},
      {"ability_shadowWarrior", "影武者"},
      {"ability_shadowWarrior_description", "作为主帅不被发现"},
      {"ability_disruptor", "军令不通"},
      {"ability_disruptor_description", "将对方主帅下回合的命令数降为1"},
      {"ability_evader", "闪转腾挪"},
      {"ability_evader_description", "部队伤亡率下降25%"},
