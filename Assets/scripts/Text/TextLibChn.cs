...
namespace TextNS
{
  ...
  //   unit
      ...
      {"ability_trapper", "草木皆兵"},
      {"ability_trapper_description", "部队红区范围增加为周围2格"},
      {"ability_consiprator", "手足相残"},
      {"ability_consiprator_description", "让来自不同地域或者不同人种的相邻敌军部队相互攻击"},
      {"ability_deciever", "疑兵"},
      {"ability_deciever_description", "让敌军部队在协同作战中无法行动"},
      {"ability_tactician", "佯败"},
      {"ability_tactician_description", "佯装败走，让敌军突前"},
