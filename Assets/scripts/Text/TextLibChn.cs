...
namespace TextNS
{
  ...
  //   unit
      ...
      {"ability_striker", "一鼓作气"},
      {"ability_striker_description", "战斗力增加100%"},
      {"ability_outlooker", "一目千里"},
      {"ability_outlooker_description", "浓雾不影响视野，发现视力范围内潜伏敌军，发现视野内敌军主帅，对遭受浓雾攻击的友军提供支援"},
      {"ability_rally", "重整旗鼓"},
      ...
      {"ability_hammer", "锐不可当"},
      {"ability_hammer_description", "冲阵成功后，对方会后撤两格"},
      ...
      {"ability_conspirator", "虚虚实实"},
      {"ability_conspirator_description", "让敌军部队在协同作战中无法行动"},
      {"ability_deciever", "佯败"},
      {"ability_deciever_description", "佯装败走，让敌军突前"},
      {"ability_mindReader", "人心惶惶"},
      {"ability_mindReader_description", "当己方有部队出现在通往敌军前线的任一补给据点旁边时，该技能对范围内前线敌军造成30-60的士气打击"},
