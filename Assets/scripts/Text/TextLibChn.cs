...
namespace TextNS
{
  ...
  //   unit
      ...
      {"ability_drillMaster", "操练大师"},
      {"ability_drillMaster_description", "和平士气部队组织度不下降"},
      ...
      {"ability_striker", "奋力一击"},
      {"ability_striker_description", "战斗力增加100%"},
      {"ability_outlooker", "千里眼"},
      {"ability_outlooker_description", "浓雾不影响视野，发现视力范围内潜伏敌军，发现视野内敌军主帅，对遭受浓雾攻击友军提供支援"},
      {"ability_generous", "千金散尽"},
      {"ability_generous_description", "范围内部队士气+50"},
      ...
      {"ability_vanguard", "破阵者"},
      {"ability_vanguard_description", "冲阵成功率增加40%"},
